...
const SIGNAL_TYPES: Record<string, { icon: string; label: string; color: string }> = {
  ...
  'consensus-update': { icon: '📈', label: 'Consensus+', color: 'bg-blue-600/20 text-blue-300 border-blue-600/30' },
  ...
  'conviction-buy': { icon: '💪', label: 'Conviction Buy', color: 'bg-pink-500/20 text-pink-400 border-pink-500/30' },
  'volume-spike': { icon: '📊', label: 'Volume Spike', color: 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30' },
  'large-position': { icon: '💰', label: 'Large Position', color: 'bg-amber-500/20 text-amber-400 border-amber-500/30' },
};
