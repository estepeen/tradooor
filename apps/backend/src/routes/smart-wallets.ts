...
router.get('/', async (req, res) => {
  try {
    ...
    const sortBy = req.query.sortBy as 'score' | 'score7d' | 'score30d' | 'winRate' | 'recentPnl30dBase' | 'recentPnl30dPercent' | 'totalTrades' | 'lastTradeTimestamp' | 'label' | 'address' | undefined;
