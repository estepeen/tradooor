module.exports = {
  apps: [
    ...
    {
      name: 'tradooor-paper-trading-monitor',
      script: 'pnpm',
      args: '--filter backend paper-trading:monitor',
      cwd: process.cwd(),
      env: {
        NODE_ENV: 'production',
      ...
      error_file: './logs/paper-trading-monitor-error.log',
      out_file: './logs/paper-trading-monitor-out.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
      merge_logs: true,
      autorestart: true,
      max_restarts: 10,
